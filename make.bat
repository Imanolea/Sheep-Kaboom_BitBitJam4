...
REM build
lcc -Wl-yt1 -Wl-yo4 -Wl-ya0 main.o story_tileset.o sprite_tileset.o sprite_bkg_tileset.o bkg_tileset.o title_map.o story_map.o game_map.o gui_map.o dev/utils/math.s -o rom/Sheep_Kaboom.gb
REM clean
del *.o *.lst